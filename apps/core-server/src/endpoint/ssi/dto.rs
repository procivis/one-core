...
#[convert(from = "OpenID4VCICredentialOfferDTO")]
...
#[derive(Clone, Debug, Serialize, ToSchema, From)]
#[convert(from = "OpenID4VCICredentialOfferCredentialDTO")]
...
#[derive(Clone, Debug, Serialize, ToSchema, From)]
#[convert(from = "OpenID4VCICredentialDefinition")]
#[serde(rename_all = "camelCase")]
...
#[derive(Clone, Debug, Serialize, ToSchema, From)]
#[convert(from = "OpenID4VCICredentialSubject")]
...
#[derive(Clone, Debug, Serialize, ToSchema, From)]
#[convert(from = "OpenID4VCICredentialValueDetails")]
