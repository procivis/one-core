...
use one_core::provider::issuance_protocol::openid4vci_draft13::model::OpenID4VCITokenRequestDTO;
use one_core::provider::verification_protocol::openid4vp_draft20::error::OpenID4VCError;
