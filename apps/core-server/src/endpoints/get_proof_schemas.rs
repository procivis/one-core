...
use crate::endpoints::{
    ...
    data_model::{ClaimsCombined, GetProofSchemaResponseDTO, ProofSchemaResponseDTO},
};
use crate::entities::{
...
mod tests {
    ...
    use super::{get_proof_schemas, proof_schema, GetProofSchemaQuery, SortableProofSchemaColumn};
