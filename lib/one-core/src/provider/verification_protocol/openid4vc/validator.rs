...
use crate::provider::verification_protocol::openid4vc::mapper::vec_last_position_from_token_path;
use crate::provider::verification_protocol::openid4vc::model::ValidatedProofClaimDTO;
