...
use crate::provider::exchange_protocol::openid4vc::model::OpenID4VPHolderInteractionData;

pub fn mdoc_presentation_context(
    interaction_data: &OpenID4VPHolderInteractionData,
    response_uri: &Url,
    verifier_nonce: &str,
    mdoc_generated_nonce: &str,
) -> Result<FormatPresentationCtx, ExchangeProtocolError> {
