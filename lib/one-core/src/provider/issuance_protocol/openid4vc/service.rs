...
use crate::provider::issuance_protocol::openid4vc::model::OpenID4VCICredentialConfigurationData;
use crate::provider::issuance_protocol::openid4vc::validator::{
...
pub(crate) fn create_issuer_metadata_response(
    ...
    let credential_configurations_supported =
        credential_configurations_supported(oidc_format, schema, config)?;
