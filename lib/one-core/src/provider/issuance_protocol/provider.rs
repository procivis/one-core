...
use super::IssuanceProtocolImpl;
...
pub(crate) trait IssuanceProtocol:
    IssuanceProtocolImpl<InteractionContext = serde_json::Value>
{
}
...
#[async_trait::async_trait]
pub(crate) trait IssuanceProtocolProviderExtra: IssuanceProtocolProvider {
...
#[cfg(test)]
mockall::mock! {
    pub(crate) IssuanceProtocolProviderExtra {}

    #[async_trait::async_trait]
    impl IssuanceProtocolProvider for IssuanceProtocolProviderExtra {
        fn get_protocol(&self, protocol_id: &str) -> Option<Arc<dyn IssuanceProtocol>>;
        fn detect_protocol(&self, url: &Url) -> Option<(String, Arc<dyn IssuanceProtocol>)>;
    }

    #[async_trait::async_trait]
    impl IssuanceProtocolProviderExtra for IssuanceProtocolProviderExtra {
        async fn issue_credential(
            &self,
            credential_id: &CredentialId,
            holder_did: Did,
...
pub(crate) struct IssuanceProtocolProviderCoreImpl {
    inner: Arc<dyn IssuanceProtocolProvider>,
...
impl IssuanceProtocolProviderCoreImpl {
    pub(crate) fn new(
        inner: Arc<dyn IssuanceProtocolProvider>,
        formatter_provider: Arc<dyn CredentialFormatterProvider>,
        credential_repository: Arc<dyn CredentialRepository>,
...
#[async_trait::async_trait]
impl IssuanceProtocolProvider for IssuanceProtocolProviderCoreImpl {
    fn get_protocol(&self, protocol_id: &str) -> Option<Arc<dyn IssuanceProtocol>> {
...
#[async_trait::async_trait]
impl IssuanceProtocolProviderExtra for IssuanceProtocolProviderCoreImpl {
    async fn issue_credential(
        &self,
        credential_id: &CredentialId,
        holder_did: Did,
