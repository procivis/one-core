use one_core::repository::{
    data_provider::{CreateProofSchemaRequest, CreateProofSchemaResponse},
...
mod tests {
    ...
    use super::*;
    use crate::entity::{ProofSchema, ProofSchemaClaimSchema};
    use one_core::repository::data_provider::ClaimProofSchemaRequest;
    ...
    async fn create_proof_schema_test_with_claims() {
        ...
        let new_claims: Vec<(Uuid, bool, u32, &str)> = (0..50)
