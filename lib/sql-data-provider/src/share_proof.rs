...
use crate::{
    ...
    entity::proof_state::ProofRequestState,
    OldProvider,
};
...
#[cfg(test)]
mod tests {
    use crate::common_queries::insert_proof_state;
    use crate::test_utilities::*;
    use crate::{
        entity::{proof_state, ProofState},
        OldProvider,
    };
    use one_core::repository::data_provider::ProofRequestState;
